...
<p>Those who accept mursal hadith only do so when the transmitter is known to narrate only from reliable sources. Abu Bakr al-Razi said in his book on usul: "Whoever we know narrates hadith from those whose narration cannot be trusted and whose hadith cannot be transmitted, such mursal hadith are not accepted by us. Our discussion is only about those who narrate exclusively from established trustworthy narrators."</p>

<p>With this, the disagreement in the issue is resolved, and the evidence from both sides converges. </p>
