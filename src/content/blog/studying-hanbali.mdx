...
Past the introductory level, the madhhab may be studied in different paths. For someone who only wants a foundation in the madhhab, it suffices to study 'Umdat al-Talib by al-Buhuti before moving onto its commentary Hidayat al-Raghib by Ibn Qa'id and studying it with a teacher as well. These two works can be considered accessible summaries of Zad al-Mustaqni' and al-Rawd al-Murbi'. Someone intending to study the madhhab in detail should read:
...
Complement this by studying Zad al-Mustaqni' by al-Hajjawi, which covers many of the masa'il not mentioned in Dalil al-Talib. This is also important for understanding the way masa'il are explained across different texts. For research on specific issues, reference its commentary by al-Buhuti.
