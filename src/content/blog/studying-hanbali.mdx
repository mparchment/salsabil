...
This curriculum assumes that reader already has a basic level of familiarity in fiqh. An excellent book for this purpose is al-Aqwal al-Mardiyyah by al-Basyuni, the shaykh of the Hanbalis at al-Azhar in his time. It defines the important terms, presents basic evidence, and was written in a way that makes it easy to understand. These features make it the ideal text to read before the curriculum, and it would also be sufficient for someone who only intends to cover the essentials of 'ibadah.

## Furūʿ al-Fiqh

### 'Umdat al-Talib by Manṣūr b. Yūnus al-Buhūtī

'Umdat al-Talib is typically the first text studied which covers every chapter in fiqh. It was the last work al-Buhuti authored, following a lifetime of teaching and writing on the madhhab's most authoritative books. As such, it presents the relied-upon position of the madhhab and is the ideal text to establish a solid foundation. 
...
Dalīl al-Ṭālib is one of the most organized books in the madhhab, and among its clearest as well. Rely on Muṣṭafā al-Ḥathlān's edition and listen to the recorded lessons of Muḥammad ʿAbd al-Wāḥid, which are indispensable for clarifying the madhhab's positions. 

The most beneficial commentary on Dalil al-Talib is that of 'Abdullah al-Maqdisi, whose father was the nephew and student of the author. In addition to frequently mentioning legal reasoning and evidence, he also brings other views from scholars within the madhhab and quotes from a wide range of sources. This commentary is invaluable for gaining a well-rounded view of the madhhab and must be read while studying Dalil al-Talib.  
...
### Al-Ādāb Al-Sharʿiyyah by Shams al-Dīn b. Mufliḥ
...
### Futūḥ al-Ghayb by ʿAbd al-Qādir al-Jīlānī
...
Complement this with Fath al-Astar by 'Abdurrahman al-Ba'li. In this book, he summarizes al-Suyuti's al-Jami' al-Saghir by only including narrations the nuqqad declared to be sahih or hasan. He further narrows his selection to include only those hadith transmitted by Ahmad, al-Bukhari, Imam Muslim, followed by his commentary on each hadith.
...
### Al-Musannaf by 'Abd al-Razzaq al-San'ani
