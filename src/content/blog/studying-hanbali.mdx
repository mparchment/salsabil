...
Dalīl al-Ṭālib is one of the clearest and most organized books in the madhhab. It can be considered equivalent to Mukhtasar al-Quduri. Rely on Muṣṭafā al-Ḥathlān's edition and listen to the recorded lessons of Muḥammad ʿAbd al-Wāḥid, which are indispensable for clarifying the madhhab's positions. 

The most beneficial commentary on Dalīl al-Ṭālib is Fatḥ Wahhāb al-Mārib by Ibn ʿIwaḍ, which is itself a compilation of earlier commentaries. It also draws from other important books in the madhhab, such as Hidāyat al-Rāghib and the commentaries of Muntahā al-Irādāt and al-Iqnāʿ. Among the commentaries Ibn ʿIwaḍ draws from is that of ʿAbdullāh al-Maqdisī, whose father was al-Karmi's nephew and his direct student. The author mentions legal reasoning, evidence, and quotes from a wide range of sources, which makes it ideal to read at the same time or after Fatḥ Wahhāb al-Mārib.
...
Complement this with Zad al-Mustaqni' by al-Hajjawi, which covers many of the masa'il not mentioned in Dalil al-Talib. Covering this is also important for understanding the way masa'il are explained across different texts. For research on specific issues, reference its commentary al-Rawd al-Murbi' by al-Buhuti.

For an introduction to comparitive fiqh and contemporary masa'il, read Hatem al-Haj's commentary on al-'Umdah by Ibn Qudamah and listen to his recorded lessons. Also read Ibn Taymiyyah's commentary, which remains one of the most comprehensive works of adillah within the madhab. He makes it a point to mention every recorded opinion and explains whether it is from the riwāyāt, wujūh, or aqwāl from the students of Ahmad. 
