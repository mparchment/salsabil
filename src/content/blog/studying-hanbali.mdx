...
Many of the following works are the relied-upon study books covered in detail with a teacher. Once completed, the longer reference books should be used for research instead. Although this guide primarily focuses on the Hanbali madhhab, it also includes some important works from scholars of other madhhabs.
...
The first stage is to study al-Rawḍ sentence-by-sentence with the objective of both understanding what is explicit and implicit in the text. An excellent work for this is al-Tashīl al-Muqniʿ by Kāmilah al-Kuwārī, which combines hawashi written on al-Rawd into a commentary. Review with Taqrīb al-Rawḍ al-Murbiʿ by ʿAbdullāh al-Muʿīdī, which reorganizes al-Rawd into question-answer format, and memorize Zad al-Mustaqni' with Milḥ al-Nad by Saʿd al-Marrī.
